...
public class TeamsStep extends BaseStep implements StepInterface {

  private static final Class<?> PKG = TeamsStepMeta.class; // for i18n purposes
  StringBuilder teamsError, teamsSuccess;
   ...
   */
  public TeamsStep(StepMeta s, StepDataInterface stepDataInterface, int c, TransMeta t, Trans dis ) {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    ...
    TeamsStepMeta meta = (TeamsStepMeta) smi;
    TeamsStepData data = (TeamsStepData) sdi;
    if ( !super.init( meta, data ) ) {
      return false;
    }

    teamsError = new StringBuilder();
    teamsError.append(meta.getMsgText());
    teamsSuccess = new StringBuilder();
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    ...
    if ( first ) {
      ...
      data.outputFieldIndex = data.outputRowMeta.indexOfValue( meta.getTeamsURL() );
      if ( data.outputFieldIndex < 0 ) {
        log.logError( BaseMessages.getString( PKG, "teamsStep.Error.NoOutputField" ) );
        setErrors( 1L );
        setOutputDone();
        return false;
      }
    ...
    teamsError.append(outputRow[0] + " name: " + outputRow[3]);
    ...
    if ( checkFeedback( getLinesRead() ) ) {
      logBasic( BaseMessages.getString( PKG, "teamsStep.Linenr", getLinesRead() ) ); // Some basic logging
    }
