...
@Step(
        id = "TeamsStep",
        name = "TeamsStep.Name",
        description = "TeamsStep.TooltipDesc",
        image = "org/pentaho/di/sdk/marketplace/steps/teams/resources/demo.svg",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform",
        i18nPackageName = "org.pentaho.di.sdk.marketplace.steps.teams",
        documentationUrl = "TeamsStep.DocumentationURL",
        casesUrl = "TeamsStep.CasesURL",
        forumUrl = "TeamsStep.ForumURL"
)

@InjectionSupported( localizationPrefix = "TeamsStepMeta.Injection." )
public class TeamsStepMeta extends BaseStepMeta implements StepMetaInterface {
   ...
   */
  private static final Class<?> PKG = TeamsStepMeta.class; // for i18n purposes

  /**
   * Stores the name of the fields added to the row-stream.
   */
  @Injection( name = "Teams_URL" )
  ...
  public StepDialogInterface getDialog( Shell shell, StepMetaInterface meta, TransMeta transMeta, String name ) {
    return new TeamsStepDialog( shell, meta, transMeta, name );
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta,
      Trans disp ) {
    return new TeamsStep( stepMeta, stepDataInterface, cnr, transMeta, disp );
  }
  ...
  public void setDefault() {
    ...
    setTeamsURL( "https://www.Teams.com" );
    setMsgText("Default Message to Teams");
  }
   ...
   * @param teamsURL the name of the field added
   */
  ...
  public String getXML() throws KettleValueException {
    ...
    xml.append( XMLHandler.addTagValue( "teamsurl", teamsURL) );
  ...
  public void loadXML( Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore ) throws KettleXMLException {
    try {
      setTeamsURL( XMLHandler.getNodeValue( XMLHandler.getSubNode( stepnode, "teamsurl" ) ) );
      setMsgText(XMLHandler.getNodeValue( XMLHandler.getSubNode( stepnode, "msgtext" ) ) );
    } catch ( Exception e ) {
      throw new KettleXMLException( "Teams plugin unable to read step info from XML node", e );
    }
  }
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    ...
    try {
      rep.saveStepAttribute( id_transformation, id_step, "teamsurl", teamsURL); //$NON-NLS-1$
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
      throws KettleException {
    try {
      teamsURL = rep.getStepAttributeString( id_step, "teamsurl" ); //$NON-NLS-1$
  ...
  public void getFields( RowMetaInterface inputRowMeta, String name, RowMetaInterface[] info, StepMeta nextStep,
    ...
    ValueMetaInterface v = new ValueMetaString(teamsURL);
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
    ...
    if ( input != null && input.length > 0 ) {
      cr = new CheckResult( CheckResult.TYPE_RESULT_OK,
        BaseMessages.getString( PKG, "Teams.CheckResult.ReceivingRows.OK" ), stepMeta );
      remarks.add( cr );
    } else {
      cr = new CheckResult( CheckResult.TYPE_RESULT_ERROR,
        BaseMessages.getString( PKG, "Teams.CheckResult.ReceivingRows.ERROR" ), stepMeta );
      remarks.add( cr );
    }
  }
}
