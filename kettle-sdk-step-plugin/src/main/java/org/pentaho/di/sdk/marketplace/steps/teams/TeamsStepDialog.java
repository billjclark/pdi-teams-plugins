 ...
 *  
 */
public class TeamsStepDialog extends BaseStepDialog implements StepDialogInterface {
   ...
   */
  private static Class<?> PKG = TeamsStepMeta.class; // for i18n purposes

  // this is the object the stores the step's settings
  // the dialog reads the settings from it when opening
  // the dialog writes the settings to it when confirmed  
  private TeamsStepMeta meta;

  // text field holding the name of the field to add to the row stream
  private LabelText wTeamsURL;
   ...
   */
  public TeamsStepDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
    super( parent, (BaseStepMeta) in, transMeta, sname );
    meta = (TeamsStepMeta) in;
  }
  ...
  public String open() {
    ...
    wTeamsURL = new LabelText( shell, BaseMessages.getString( PKG, "Teams.FieldName.Label" ), null );
    props.setLook(wTeamsURL);
    wTeamsURL.addModifyListener( lsMod );
    FormData fdValName = new FormData();
    fdValName.left = new FormAttachment( 0, 0 );
    fdValName.right = new FormAttachment( 100, 0 );
    fdValName.top = new FormAttachment( wStepname, margin );
    wTeamsURL.setLayoutData( fdValName );

//    wMsgText = new LabelText( shell, "BaseMessages", null );
    wMsgText = new LabelText( shell, BaseMessages.getString( PKG, "Teams.MsgText.Label" ), null );
    ...
    setButtonPositions( new Button[] { wOK, wCancel }, margin, wTeamsURL);
    ...
    wTeamsURL.addSelectionListener( lsDef );
  ...
  private void populateDialog() {
    wStepname.selectAll();
    wTeamsURL.setText( meta.getTeamsURL() );
  ...
  private void ok() {
    ...
    meta.setTeamsURL( wTeamsURL.getText() );
