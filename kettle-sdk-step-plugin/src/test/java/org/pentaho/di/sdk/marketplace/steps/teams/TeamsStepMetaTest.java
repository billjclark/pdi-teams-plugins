...
public class TeamsStepMetaTest {
  ...
  public void testGetStepData() {
    org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta m = new org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta();
    assertEquals( TeamsStepData.class, m.getStepData().getClass() );
  }
  ...
  public void testStepAnnotations() {
    ...
    Step stepAnnotation = org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class.getAnnotation( Step.class );
    ...
    assertEquals( org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class.getPackage().getName(), stepAnnotation.i18nPackageName() );
    ...
    InjectionSupported injectSupportAnnotation = org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class.getAnnotation( InjectionSupported.class );
    ...
    for ( Field field : org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class.getDeclaredFields() ) {
      if ( field.isAnnotationPresent( Injection.class ) || field.isAnnotationPresent( InjectionDeep.class ) ) {
        hasInjection = true;
      }
    }
    for ( Method method : org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class.getDeclaredMethods() ) {
  ...
  public void testDefaults() throws KettleStepException {
    ...
    m.getFields( rowMeta, "teams_step", null, null, null, null, null );
    ...
    assertEquals( rowMeta.getFieldNames()[0], m.getTeamsURL() );
  }
  ...
  public void testLoadSave() throws KettleException {
     ...
     */
    List<String> attributes = Arrays.asList( "TeamsURL" );
     ...
     */
    LoadSaveTester<org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta> tester =
      new LoadSaveTester<org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta>( org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class, attributes );
  ...
  public void testChecks() {
    ...
    for ( CheckResultInterface result : checkResults ) {
      if ( result.getType() == CheckResultInterface.TYPE_RESULT_ERROR
          && result.getText().equals( BaseMessages.getString( org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class, "Teams.CheckResult.ReceivingRows.ERROR" ) ) ) {
        foundMatch = true;
      }
    }
    ...
    for ( CheckResultInterface result : checkResults ) {
      if ( result.getType() == CheckResultInterface.TYPE_RESULT_OK
          && result.getText().equals( BaseMessages.getString( org.pentaho.di.sdk.marketplace.steps.teams.TeamsStepMeta.class, "Teams.CheckResult.ReceivingRows.OK" ) ) ) {
        foundMatch = true;
      }
    }
    assertTrue( "The step checks should fail if no input fields are given", foundMatch );
